...
namespace StackExchange.Exceptional
{
    ...
    public class HandlerFactory : IHttpHandlerFactory
    {
            ...
            switch(context.Request.HttpMethod)
            {
                ...
                case "GET":
                    switch (resource.ToLower(CultureInfo.InvariantCulture))
                    {
                        ...
                        case "info":
                            return PageHandler(new ErrorInfo(context.Request.QueryString["guid"].ToGuid()));
                        ...
                        default:
                            ...
                            return PageHandler(new ErrorListPage());
                    }
                default:
        ...
        private IHttpHandler PageHandler(WebPage page)
        {
