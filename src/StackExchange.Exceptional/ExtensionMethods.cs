...
namespace StackExchange.Exceptional.Extensions
{
    ...
    public static class ExtensionMethods
    {
        ...
        /// </summary>
        public static string IsNullOrEmptyReturn(this string s, string otherPossibility) => s.HasValue() ? s : otherPossibility;
        ...
        public static List<T> All<T>(this List<T> source) => source;
        ...
        /// </summary>
        public static string ToJson(this object o) => JSON.Serialize(o);
    }
}